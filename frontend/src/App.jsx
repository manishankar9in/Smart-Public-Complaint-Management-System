...
import VerifyWorkerEmail from './pages/VerifyWorkerEmail';
import VerifyCitizenEmail from './pages/VerifyCitizenEmail';
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/verify-worker-email" element={<VerifyWorkerEmail />} />
      <Route path="/verify-citizen-email" element={<VerifyCitizenEmail />} />
      <Route path="/verify-email" element={<VerifyWorkerEmail />} />
