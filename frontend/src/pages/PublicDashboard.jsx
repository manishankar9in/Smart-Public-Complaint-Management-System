...
import { getStatusColor, getPriorityColor } from "../data/categoryMapping";
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1.5">
                        <span className={`rounded border px-2 py-0.5 text-[10px] font-bold ${getPriorityColor(c.priority_level)}`}>
