  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res?.email_sent === false) {
        toast.info("Complaint submitted successfully. Email notification could not be sent at this time.");
      } else {
        toast.success("Complaint submitted successfully! Confirmation email sent.");
      }
      setStep(3);
    } catch (err) {
